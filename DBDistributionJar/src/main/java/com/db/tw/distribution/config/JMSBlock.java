...
public class JMSBlock extends AbstractBlock {
	...
	final private String[] propNames = { SERVERID_PROP_NAME,
			BROKERURL_PROP_NAME, TOPICNAME_PROP_NAME, FACTORY_PROP_NAME,
			RETRYCOUNTER_PROP_NAME, MAXIDLE_PROP_NAME, MINIDLE_PROP_NAME };

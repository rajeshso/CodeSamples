...
public class BlockManager {
	...
	private synchronized static void loadConfig() {
		configList.clear();
		bKeyToConfigMap.clear();
		System.out
				.printf("initial configList size is %s %n", configList.size());
		...
		System.out.printf("final configList size is %s %n", configList.size());
	}
	...
	public synchronized static Set<IBlock> getMatchingConfigsForBKeys(
	...
	public static void setConfigList(Set<IBlock> iblockSet) {
		configList = iblockSet;
	}

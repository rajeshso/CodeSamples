...
public class JMSSpout extends BaseRichSpout {
	...
	public void open(Map conf, TopologyContext context,
		...
		System.out.println("JMSSpout open is invoked");
	...
	@Override
	public void close() {
		System.out.println("JMSSpout close is invoked");
	}
	...
	public void activate() {
		System.out.println("JMSSpout activate is invoked");
	}
	...
	public void deactivate() {
		System.out.println("JMSSpout decativate is invoked");
	}
	...
	public void nextTuple() {
		...
		Values tuplePayloadOne = new Values("payLoadField1", 1, 2, 3);
		Values tuplePayloadTwo = new Values("payLoadField2", 3,2,1);
		this.collector.emit(tuplePayloadOne);
		this.collector.emit(tuplePayloadTwo);
		this.completed = true;
	}
	...
	public void ack(Object msgId) {
		System.out.println("Thank you acknowledgement from JMSSpout for msgID "+msgId);
	}
	...
	public void fail(Object msgId) {
		System.out.println("JMSSpout fail method is called");
	}
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		System.out.println("JMSSpout declareOutputFields method is called");
		declarer.declare(new Fields("TheJMSSpoutField"));
	}

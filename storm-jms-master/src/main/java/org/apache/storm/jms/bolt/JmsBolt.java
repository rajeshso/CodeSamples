...
public class JmsBolt extends BaseRichBolt {
	...
	public JmsBolt() {
		super();
		System.out.println("I am JmsBolt "+ this.hashCode());
	}

	private static final long serialVersionUID = 6920246799026392119L;

	public static Logger LOG = LoggerFactory.getLogger(JmsBolt.class);
	...
	// JMS options
	public boolean jmsTransactional = false;
	public int jmsAcknowledgeMode = Session.AUTO_ACKNOWLEDGE;
...
/*			
// The sleep helps in reliable subscription 
 			try {
				Thread.sleep(1000);
	...
	public void cleanup() {
		try {
			...
			System.out.println("cleanup for "+this.hashCode());
			this.session.close();
	...
	public void prepare(Map stormConf, TopologyContext context,
		...
		System.out.println("JmsBolt prepare called for "+ this.hashCode());
